...
<DefaultButton variant="primary" type="icon-left" icon={<FaArrowLeft />}>
  Back
      ...
      <DefaultButton variant="primary" size="small" icon={<span>Icon</span>} onClick={onClick} disabled={true}>
        Login
        </DefaultButton>
        <DefaultButton variant="tertiary" icon={<span>Icon</span>} onClick={onClick} disabled={true}>
        Login
        </DefaultButton>
        <DefaultButton variant="black" icon={<span>Icon</span>} onClick={onClick} disabled={true}>
        Login
        </DefaultButton>
        <DefaultButton variant="secondary" icon={<span>Icon</span>} onClick={onClick} disabled={true}>
        Login
        </DefaultButton>
