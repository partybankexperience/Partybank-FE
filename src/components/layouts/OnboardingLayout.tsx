...
//           {/* Replace with Step Components */}
//           {stepParam === "emailVerification" && <EmailVerification />}
//           {stepParam === "passwordSetup" && <PasswordSetup />}
//           {stepParam === "profileInformation" && <ProfileInfo />}
//           {stepParam === "pinSetup" && <PinSetup />}
//           {stepParam === "createEventSeries" && <EventCreation />}
