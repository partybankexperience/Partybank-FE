...
const CreateNewEvent = () => {
  ...
  return (
    <button className="bg-[#FFF2F4] rounded-[10px] px-[20px] min-h-fit h-[157px] md:min-h-[347px] md:h-full min-w-[180px] w-full  grid justify-center items-center cursor-pointer hover:shadow-[0px_4px_20px_rgba(0,0,0,0.1)] transition-all duration-300" onClick={() => navigate("/dashboard/createEvent")}>
