...
const CreateNewEvent = () => {
  ...
  return (
    <button
      className="bg-[#FFF2F4] rounded-[10px] px-[20px] min-h-fit h-[157px] md:min-h-[347px] md:h-full min-w-[180px] w-full  grid justify-center items-center cursor-pointer hover:shadow-[0px_4px_20px_rgba(0,0,0,0.1)] transition-all duration-300"
      ...
      <div className="grid gap-[20px] text-center">
        ...
        <div className="grid gap-[8px] text-center">
          ...
          <p className="text-lightGrey font-medium text-[.875rem]">
            Create a event to keep your events put together
          </p>
        </div>
      </div>
    </button>
