...
const ScheduleEvent = () => {
  ...
  useEffect(() => {
    if (
      scheduleEventForm.showLocation !== undefined &&
      scheduleEventForm.showLocation !== showLocation
    ) {
      ...
      <div className="grid gap-[20px]">
        ...
        >
          ...
          {scheduleEventErrors.eventType && (
            <p className="text-[13px] text-red-500 mt-1">{scheduleEventErrors.eventType}</p>
          )}
        </div>
        ...
        <div className="grid gap-[10px]">
          ...
          <div className="flex items-center gap-4">
            <SlideToggle toggle={handleLocationToggle} isChecked={showLocation} />
        ...
        {showLocation && (
          <>
            ...
            <div className="grid gap-2">
              <label className="text-black text-[1rem] font-semibold">Event Location *</label>
