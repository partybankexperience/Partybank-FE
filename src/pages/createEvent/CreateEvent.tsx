      ...
      if (stage === 'Tickets Create') {
        try {
          ...
          const validateTicket = () => {
            ...
            if (
              !currentTicket.totalStock &&
              (currentTicket.isUnlimited === false || currentTicket.isUnlimited === '')
            ) {
          ...
          if (hasCurrentTicketData) {
            ...
            try {
              ...
              const ticketPayload = [
                ...
                !currentTicket.isUnlimited ? Number(currentTicket.totalStock) : 0,
            ...
            const nextUnsavedIndex = updatedTickets.findIndex(
              (ticket, index) =>
                index !== activeIndex && (!ticket.id || ticket.id === '' || ticket.id === null),
            );
      ...
      if (stage === 'Accessibility') {
        try {
          ...
          setError(
            stage,
            'general',
            'An unexpected error occurred while updating accessibility settings.',
          );
          return;
        } finally {
          setIsCreatingEvent(false);
        ...
        <div className="flex gap-3 mt-auto justify-center pt-6">
          ...
          {stage !== 'Review & Publish' ? (
            <DefaultButton
              ...
              disabled={isNextButtonDisabled || isCreatingEvent}
            >
