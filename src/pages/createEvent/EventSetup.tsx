...
const EventSetup = () => {
      ...
      try {
        ...
        if (response && response.length > 0) {
          ...
          if (eventSetupForm.tags ) {
            const matchedTag = response.find(
              (tag: any) => tag.id === eventSetupForm.tags
            );
            if (matchedTag) {
  ...
  const handleNameBlur = async () => {
    ...
    try {
      ...
      console.log(
        "Calling checkSimilarEvent API with:",
        eventName,
        currentDate
      );
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-orange-700">
                  ...
                  <p className="mt-2 text-xs">
                    Consider using a different name to avoid confusion with
                    existing events.
                  </p>
                </div>
              </div>
      ...
      {eventSetupForm.tags === "Other" && (
        <>
          ...
          <DefaultInput
            ...
            setValue={(value: string) =>
              handleInputChange("newTagDescription", value)
            }
